...
Расписание cron указано в UTC: `16:00`, `17:00`, `18:00 UTC` соответствуют резервным стартам
в 21:00, 22:00 и 23:00 по Алматы. Это резервирование нужно потому, что GitHub может задержать или
пропустить scheduled-run. Один длительный job надежнее серии коротких cron-запусков.
