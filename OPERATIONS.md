...
- GitHub Actions запускает одноразовую проверку каждые 5 минут в вечернем окне;
...
Расписание cron указано в UTC. Для времени Алматы окно 16:00-18:55 UTC соответствует 21:00-23:55.
GitHub Actions может запускать cron с небольшой задержкой.
